   ...
   function Genetic() {
      ...
      this.start = function () {
         ...
         while (this.iteration < this.configuration.iterations) {
            this.iteration++;
            // take a small break for the UI to be able to interrupt the process
            if (i % 100 == 0)
               setTimeout(this.nextGen, 50)
            else
               this.nextGen()
         }
      }
      ...
      this.nextGen = function () {
         ...
         if (i > this.configuration.iterations || this.done)
            return;
         ...
         var isFinished = this.done || (typeof r != "undefined" && !r) || (i == this.configuration.iterations - 1);
